    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the Tuna protocol have made
      ...
      return (
        <div>
          <p>Attention TUNA Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with TUNA is Tuna/yCRV
            (Curve yPool tokens)
          </p>
